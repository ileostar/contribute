...
Hey there! We are really excited that you are interested in contributing. This is a general contribution guide for most of LeoStar's projects. Before submitting your contribution, please make sure to take a moment and read through the following guide:
...
Under projects with configuration as shown on the right, corepack will install `v8.14.0` of `pnpm` (if you don't have it already) and use it to run your commands. This makes sure everyone working on this project have the same behavior for the dependencies and the lockfile.
...
In case you are interested in, here is LeoStar's personal configrations and setups:

CLI Tools

In addition of `ni`, here is a few cmd aliases to be even lazier:

- [ileostar/cmd-alias](https://github.com/ileostar/cmd-alias) - CMD alias configuration
- [ileostar/leostar-spec](https://github.com/ileostar/leostar-spec) - lint spec config
- [ileostar/vscode-settings](https://github.com/antfu/vscode-settings) - VS Code settings
